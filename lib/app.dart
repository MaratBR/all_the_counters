...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
        providers: _repositoryProviders(), child: _buildApp());
  }
  ...
  List<RepositoryProvider> _repositoryProviders() {
    return [
      RepositoryProvider<SnapshotsRepository>(
          create: (context) => SnapshotsRepository(context)),
      RepositoryProvider<CountersRepository>(
          create: (context) => CountersRepository(context)),
      RepositoryProvider<MetadataRepository>(
          create: (context) => MetadataRepository(context)),
    ];
  }
  ...
  ThemeData _themeDark() {
    return ThemeData.dark().copyWith(
        ...
        textTheme: TextTheme(
            ...
            subtitle2: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)));
  }
  ...
  ThemeData _theme() => ThemeData(
      ...
      textTheme: TextTheme(
          button: TextStyle(fontFamily: 'OpenSans'),
          headline2: TextStyle(fontSize: 40, fontWeight: FontWeight.w100),
          subtitle2: TextStyle(
